...
import static com.kv.webflux.logging.util.TestUtils.formatToLoggedReqId;
...
public class ReqIdMessageFormatterUnitTest extends BaseTest {
    ...
    void addData_whenNeedLog_thenReturnWithReqId() {
        ...
        assertAll(
                ...
                () -> assertTrue(withReqId.getLogMessage().contains(TestUtils.formatToLoggedReqId(response.logPrefix())))
        );
    }
    ...
    void addData_whenNeedLog_thenReturnWithReqIdAndWithReqIdPrefix() {
        ...
        assertAll(
                ...
                () -> assertTrue(withReqId.getLogMessage()
                        .contains(TestUtils.formatToLoggedReqId(response.logPrefix(), reqIdPrefix)))
        );
    }
}