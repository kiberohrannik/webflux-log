...
public abstract class BaseComponentTest extends BaseTest {
    ...
    private static final List<RequestMetadataMessageFormatter> requestFormatters = List.of(
    ...
    private static final BodyClientRequestFormatter bodyRequestFormatter = new BodyClientRequestFormatter();
    private static final BodyClientResponseFormatter bodyResponseFormatter = new BodyClientResponseFormatter();


    protected static WebClient createTestRequestLogWebClient(LoggingProperties properties,
                                                             @Nullable String requestBody) {

        RequestMessageCreator messageCreator = new BaseRequestMessageCreator(properties,
                requestFormatters, bodyRequestFormatter);
    ...
    protected static WebClient createTestResponseLogWebClient(LoggingProperties properties,
        ...
        ResponseMessageCreator messageCreator = new BaseResponseMessageCreator(properties,
                responseFormatters, bodyResponseFormatter);
