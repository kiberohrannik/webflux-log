package com.kiberohrannik.webflux_addons.logging.server.component;
...
import static com.kiberohrannik.webflux_addons.logging.server.app.TestController.RESPONSE_PREFIX;
import static com.kiberohrannik.webflux_addons.logging.server.app.TestController.TEST_ENDPOINT;
...
public class LoggingFilterComponentTest extends BaseIntegrationTest {
    ...
    void filter_whenReturned200_thenLogFullRequest_andFullResponse(CapturedOutput output)
        ...
        String expectedResponseBody = requestBody + RESPONSE_PREFIX;
