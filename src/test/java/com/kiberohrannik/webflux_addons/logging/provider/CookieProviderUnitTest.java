...
public class CookieProviderUnitTest extends BaseTest {
    ...
    private final LoggingProperties propsNoMasked = LoggingProperties.builder().build();
    ...
    void createClientRequestMessage_whenMasked_thenAddWithMask() {
        ...
        assertAll(
                ...
                () -> assertEquals(2, StringUtils.countMatches(actual, cookieName0 + "=" + DEFAULT_MASK)),

                () -> assertFalse(actual.contains(cookieName1 + "=" + cookieValue1)),
                () -> assertTrue(actual.contains(cookieName1 + "=" + DEFAULT_MASK)),
    ...
    void createServerRequestMessage_whenMasked_thenAddWithMask(HttpCookie cookie0, HttpCookie cookie1,
        ...
        assertAll(
                ...
                () -> assertEquals(2, StringUtils.countMatches(actual, cookie0.getName() + "=" + DEFAULT_MASK)),

                () -> assertFalse(actual.contains(cookie1.toString())),
                () -> assertTrue(actual.contains(cookie1.getName() + "=" + DEFAULT_MASK)),

                () -> assertFalse(actual.contains(cookie2.toString())),
                () -> assertTrue(actual.contains(cookie2.getName() + "=" + DEFAULT_MASK)),
